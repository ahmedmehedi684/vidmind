...
const features = [
  ...
  },
  {
    icon: Clock,
    title: "Full History",
    desc: "Every video you summarize is saved in your history. Continue where you left off, add more notes, or revisit old insights anytime.",
  },
  {
    icon: Search,
    title: "Search & Filter",
...
const fallbackHistoryCards = [
  {
    channel_name: "Natalie Dawson",
    title: "Speed is the Key to Success",
    display_date: "March 19, 2025",
    tags: ["Business", "Mindset", "Speed"],
    thumbnail_url: "",
    video_url: "",
  },
  {
    channel_name: "Alex Hormozi",
    title: "How to Make $1M Without Being Lucky",
    display_date: "March 17, 2025",
    tags: ["Money", "Business"],
    thumbnail_url: "",
    video_url: "",
  },
  {
    ...
    title: "The Science of Learning Anything 10x Faster",
...
const LandingPage = () => {
  ...
  return (
    <div
      ...
      style={{ background: "#0a0d14", color: "#f0f4ff", fontFamily: "'DM Sans', sans-serif", scrollBehavior: "smooth" }}
    >
      {/* Navbar */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 border-b"
        style={{ background: "rgba(10,13,20,0.92)", backdropFilter: "blur(16px)", borderColor: "#1e2535" }}
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between h-16 px-4 md:px-6">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold" style={{ color: "#00ff87", fontFamily: "'DM Sans', sans-serif" }}>
              VidMind
            </span>
          </Link>
          <div className="hidden md:flex items-center gap-6">
            {navLinks.map((l) => (
              <button
                ...
                style={{ color: activeSection === l.href.slice(1) ? "#00ff87" : "#8892a4" }}
              >
                {l.label}
              </button>
            ))}
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              <>
                <Link to="/app">
                  <Button size="sm" className="text-[#0a0d14] font-semibold" style={{ background: "#00ff87" }}>
                    Open App
                  </Button>
                </Link>
                <Link to="/app-profile">
                  <Avatar className="h-8 w-8 cursor-pointer">
                    <AvatarFallback className="bg-[#00ff87] text-[#0a0d14] text-xs font-semibold">
                      {initials}
                    </AvatarFallback>
                  </Avatar>
                </Link>
              ...
              <>
                <Link to="/auth">
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-[#1e2535] text-[#f0f4ff] hover:bg-[#1e2535] bg-transparent"
                  >
                    Login
                  </Button>
                </Link>
          ...
          <button className="md:hidden" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            {mobileMenuOpen ? (
              <X className="h-6 w-6" style={{ color: "#f0f4ff" }} />
            ) : (
              <Menu className="h-6 w-6" style={{ color: "#f0f4ff" }} />
            )}
          </button>
        </div>
        {mobileMenuOpen && (
            ...
            <div className="flex gap-2 pt-2">
              {user ? (
                <Link to="/app" className="flex-1">
                  <Button className="w-full text-[#0a0d14] font-semibold" size="sm" style={{ background: "#00ff87" }}>
                    Open App
                  </Button>
                </Link>
              ) : (
                <>
                  <Link to="/auth" className="flex-1">
                    <Button
                      variant="outline"
                      className="w-full border-[#1e2535] text-[#f0f4ff] bg-transparent"
                      size="sm"
                    >
                      Login
                    </Button>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 60% 50% at 50% 30%, rgba(0,255,135,0.08) 0%, transparent 70%)",
          }}
        />
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <button onClick={() => scrollTo("#how-it-works")}>
              <Button
                variant="outline"
                size="lg"
                className="h-12 px-8 text-base border-[#1e2535] text-[#f0f4ff] bg-transparent hover:bg-[#1e2535]"
              >
                See How it Works
              </Button>
            </button>
          ...
          <div
            ...
            style={{ background: "#0f1320", border: "1px solid #1e2535" }}
          >
            <div className="flex items-center gap-2 px-4 py-3" style={{ borderBottom: "1px solid #1e2535" }}>
              ...
              <div className="flex-1 text-center text-xs" style={{ color: "#8892a4" }}>
                vidmind.app
              </div>
            </div>
            <div className="p-6 space-y-4">
              ...
              <div
                ...
                style={{ background: "#111827", border: "1px solid #1e2535", color: "#8892a4" }}
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
                <div className="rounded-lg p-4" style={{ background: "#111827", border: "1px solid #1e2535" }}>
                  <h4 className="text-sm font-semibold mb-2" style={{ color: "#00ff87" }}>
                    Main Story
                  </h4>
                  <p className="text-xs" style={{ color: "#8892a4" }}>
                    The video explains how consistent daily habits compound into extraordinary results over time...
                  </p>
                </div>
                <div className="rounded-lg p-4" style={{ background: "#111827", border: "1px solid #1e2535" }}>
                  <h4 className="text-sm font-semibold mb-2" style={{ color: "#00ff87" }}>
      ...
      <section
        ...
        style={{ background: "#0f1320", borderTop: "1px solid #1e2535", borderBottom: "1px solid #1e2535" }}
      >
          ...
          {[
            ...
            <div key={s.label}>
              <p
                ...
                style={{ color: "#00ff87", fontFamily: "'Playfair Display', serif" }}
              >
                {s.val}
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f) => (
              ...
              >
                ...
                <h3 className="font-semibold text-lg mb-2" style={{ color: "#f0f4ff" }}>
                  {f.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((s) => (
              <div key={s.num} className="text-center space-y-4">
                <div
                  className="h-14 w-14 rounded-full flex items-center justify-center mx-auto text-xl font-bold"
                  style={{
                    background: "rgba(0,255,135,0.1)",
                    color: "#00ff87",
                ...
                <h3 className="font-semibold text-lg" style={{ color: "#f0f4ff" }}>
                  {s.title}
                </h3>
      ...
      <section id="notes" className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center max-w-md mx-auto mb-12" style={{ color: "#8892a4" }}>
            Organize everything you learn — by channel, by topic, by date.
          </p>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-64 p-5 space-y-1" style={{ borderRight: "1px solid #1e2535" }}>
                ...
                {channelsList.map((ch) => (
                  <div
                    key={ch.name}
                    className="flex items-center justify-between px-3 py-2 rounded-lg text-sm cursor-pointer hover:bg-[#1e2535]/50"
                  >
                ...
                <div className="flex items-center gap-2 px-3 py-2 text-sm cursor-pointer" style={{ color: "#00ff87" }}>
                  + Add Channel
                </div>
              </div>
              {/* Content */}
              <div className="flex-1 p-5">
                <div className="flex flex-wrap gap-1.5 mb-4 pb-3" style={{ borderBottom: "1px solid #1e2535" }}>
                  {["B", "I", "U", "H1", "H2", "List", "Link", "Image", "Save"].map((btn) => (
                    <div
                      ...
                      style={{ background: "#1e2535", color: "#8892a4" }}
                    >
                      {btn}
                    </div>
                  ))}
                ...
                <div className="space-y-2 text-sm" style={{ color: "#8892a4" }}>
                  <p>
                    The key takeaway from this video is that building a massive business comes down to{" "}
                    <strong style={{ color: "#f0f4ff" }}>solving painful problems</strong> at scale.
                  </p>
      ...
      <section id="history" className="py-20 px-4" style={{ background: "#0f1320" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center max-w-md mx-auto mb-12" style={{ color: "#8892a4" }}>
            Every video you summarize is saved. Pick up where you left off.
          </p>
            ...
            {historyCards.map((h: any) => (
              ...
              >
                ...
                <div className="p-4 space-y-2">
                  ...
                  <h4 className="font-semibold text-sm" style={{ color: "#f0f4ff" }}>
                    {h.title}
                  </h4>
                  <p className="text-xs" style={{ color: "#8892a4" }}>
                    {h.display_date}
            ...
            {testimonials.map((t) => (
              ...
              >
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="h-4 w-4 fill-current" style={{ color: "#00ff87" }} />
                  ))}
                </div>
                <p className="text-sm italic leading-relaxed" style={{ color: "#8892a4" }}>
                  "{t.text}"
                </p>
      ...
      <section id="pricing" className="py-20 px-4" style={{ background: "#0f1320" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center max-w-md mx-auto mb-6" style={{ color: "#8892a4" }}>
          ...
          <div className="flex items-center justify-center gap-1 mb-10">
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-semibold transition-all ${pricingCurrency === "BDT" ? "text-[#0a0d14]" : "text-[#8892a4]"}`}
              style={
                pricingCurrency === "BDT"
                  ? { background: "#00ff87" }
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-semibold transition-all ${pricingCurrency === "USD" ? "text-[#0a0d14]" : "text-[#8892a4]"}`}
              style={
                pricingCurrency === "USD"
                  ? { background: "#00ff87" }
                  : { background: "transparent", border: "1px solid #1e2535" }
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: "radial-gradient(ellipse 50% 60% at 50% 50%, rgba(0,255,135,0.06) 0%, transparent 70%)",
          }}
        />
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <Link to="/auth">
            <Button
              size="lg"
              className="h-13 px-10 text-base font-semibold gap-2 text-[#0a0d14]"
              style={{ background: "#00ff87" }}
            >
              Get Started Free <ChevronRight className="h-5 w-5" />
            </Button>
      ...
      <footer className="py-8 px-4" style={{ borderTop: "1px solid #1e2535" }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-sm">
            <Link to="/privacy-policy" className="transition-colors hover:text-[#00ff87]" style={{ color: "#8892a4" }}>
              Privacy Policy
            </Link>
            <Link
              to="/terms-of-service"
          ...
          <p className="text-sm" style={{ color: "#8892a4" }}>
            © 2025 VidMind. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
